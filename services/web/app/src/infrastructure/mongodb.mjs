...
export const db = {
  appConfigAuditLogs: internalDb.collection('appConfigAuditLogs'),
  appConfigRevisions: internalDb.collection('appConfigRevisions'),
  appConfigValues: internalDb.collection('appConfigValues'),
