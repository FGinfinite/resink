...
Object.values(Settings.i18n.subdomainLang || {}).forEach(function (spec) {
  ...
  //  middleware; keep the first mapping per host so cookie-only languages
  //  sharing siteUrl do not replace the default host language.
