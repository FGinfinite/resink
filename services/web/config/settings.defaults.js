...
module.exports = {
  ...
  runtimeConfig: {
    cacheTtlMs:
      parseInt(process.env.RUNTIME_CONFIG_CACHE_TTL_MS || '30000', 10) ||
      30000,
    fallbackRefreshIntervalMs:
      parseInt(
        process.env.RUNTIME_CONFIG_FALLBACK_REFRESH_INTERVAL_MS || '30000',
        10
      ) || 30000,
  },
  ...
  // GitHub OAuth login (optional, supplement to email/password)
  ...
  oauthProviders: {
    ...(process.env.GITHUB_OAUTH_CLIENT_ID &&
      process.env.GITHUB_OAUTH_CLIENT_SECRET && {
        github: {
          name: 'GitHub',
          descriptionKey: 'login_with_github',
  ...
  enableAiAssistant:
    process.env.OVERLEAF_ENABLE_AI_ASSISTANT === 'true' ||
    process.env.OVERLEAF_ENABLE_AI_ASSISTANT === undefined,
  ...
  pdfCachingMinChunkSize:
    parseInt(process.env.PDF_CACHING_MIN_CHUNK_SIZE || '1024', 10) || 1024,
  ...
  // Set ADMIN_EMAIL and ADMIN_PASSWORD in dev.env.local to enable.
  autoCreateAdmin: {
