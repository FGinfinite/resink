...
export default defineConfig([
    ...
    rules: {
      'import/no-unresolved': [
        'error',
        {
          ...
          ignore: [
            '^p-queue$',
            // Optional Server Pro/SaaS modules and generated local configs are
            // absent from the CE source tree used for this upgrade branch.
            '^\\.\\./+config/settings\\.(overrides\\.(server-pro|saas)|webpack)\\.js$',
            '^\\.\\./+modules/(dropbox|group-settings|institutions|learn|library|notifications|oauth2-server|saas-authentication|subscriptions)/',
            '^\\.\\./+\\.\\./modules/oauth2-server/',
            '^\\.\\./+\\.\\./\\.\\./modules/learn/',
            '^\\.\\./+\\.\\./\\.\\./scripts/recurly/',
            '^\\.\\./+\\.\\./\\.\\./\\.\\./admin-panel/test/acceptance/src/mocks/MockV1Api\\.mjs$',
            '^\\.\\./+\\.\\./\\.\\./\\.\\./modules/(group-settings|oauth2-server|subscriptions)/',
            '^\\./stripe/helpers\\.mjs$',
          ],
        },
      ],
  ...
  },
  {
    ...
    ignores: [
      ...
      'modules/server-ce-scripts/scripts/auto-create-admin.mjs',
