...
import { ToolbarAIStatus } from '@/features/ai-assistant/components/toolbar-ai-status'
import { CompletionStatusIndicator } from '@/features/ai-assistant/components/completion-status-indicator'
  ...
  return (
    <nav className="ide-redesign-toolbar" aria-label={t('project_actions')}>
      ...
      <div className="ide-redesign-toolbar-actions">
        ...
        <ToolbarAIStatus />
        <span className="ide-redesign-toolbar-separator" aria-hidden="true" />
        <OnlineUsers />
